...
class NavBar extends React.Component {
  ...
  links() {
    ...
    if (this.props.auth.isAuthenticated) {
      return (
        <div>
          <li><Link to="/add-event" style={styles.fontWeight}><FaPlus size={'29px'} /><span className="menu-item">Add Event</span></Link></li>
          <li><a onClick={() => this.props.dispatch(logout())} style={styles.fontWeight}><FaSignOut size={'29px'} /><span className="menu-item">Logout</span></a></li>
        </div>
      );
    } else {
      return (
        <div>
          <li><Link to="/add-event" style={styles.fontWeight}><FaPlus size={'29px'} /><span className="menu-item">Add Event</span></Link></li>
          <li><Link to="/login" style={styles.fontWeight}><FaSignIn size={'29px'} /><span className="menu-item">Login</span></Link></li>
          <li><Link to="/signup" style={styles.fontWeight}><FaSignUp size={'29px'} /><span className="menu-item">Sign Up</span></Link></li>
        </div>
      );
    }
  }
      ...
      <nav style={styles.navBarColor}>
        <div className="nav-wrapper">
          ...
          <div style={{cursor: 'pointer', display: this.props.routing.locationBeforeTransitions.pathname === '/' ? 'block' : 'none'}} className="right viewIcon" onClick={this.viewChange}>
            {this.props.view.icon === 'map' ? <FaMap size={'29px'} /> : <FaList size={'29px'} />}
          </div>
          <ul className="side-nav" id="mobile">
            <li><Link to="/about" style={styles.fontWeight}><FaInfo size={'29px'} /><span className="menu-item">About</span></Link></li>
            ...
            <li
              ...
              <Link to="/" style={styles.fontWeight}><FaMap size={'29px'} /><span className="menu-item">Map View</span></Link></li>
            <li onClick={this.navbarViewChangeList}><Link to="/" style={styles.fontWeight}><FaList size={'29px'} /><span className="menu-item">List View</span></Link></li>
            {this.links()}
          </ul>
        </div>
      </nav>
